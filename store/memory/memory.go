...
func (m *memoryStore) Get(key string, opts ...store.ReadOption) (*store.Record, error) {
...
func (m *memoryStore) Set(r *store.Record, opts ...store.WriteOption) error {
